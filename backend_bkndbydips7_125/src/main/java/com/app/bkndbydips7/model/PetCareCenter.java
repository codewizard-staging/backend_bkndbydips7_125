package com.app.bkndbydips7.model;
...
import com.app.bkndbydips7.converter.DurationConverter;
import com.app.bkndbydips7.converter.UUIDToByteConverter;
import com.app.bkndbydips7.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"bkndbydips7\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"bkndbydips7\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"bkndbydips7\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"bkndbydips7\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"bkndbydips7\"")
